...
public class UserDetailsImpl implements UserDetails {
	...
	public static UserDetailsImpl build(Personnel user) {
		List<GrantedAuthority> authorities = user.getRoles().stream()
				.map(role -> new SimpleGrantedAuthority(role.getNomRole().name())).collect(Collectors.toList());

		return new UserDetailsImpl(user.getIdEmploye(), user.getEmail(), user.getMatriculeP(), user.getNom()
				,user.getPassword(),user.getDepartement()
