...
import tn.arabsoft.auth.payload.request.ForgotPasswordRequest;
...
import tn.arabsoft.auth.response.ForgotPasswordResponse;
...
public class Auth {
	...
	@GetMapping("/gett/{mat}")
	public UserDetails gett(@PathVariable String mat) {
		return this.detailsServiceImpl.loadUserByUsername(mat);
	}
	@PostMapping("/signin")
	public ResponseEntity<?> authenticateUser(@RequestBody LoginRequest loginRequest) {
		...
		return ResponseEntity.ok(new JwtResponse(jwt, "Bearer", userDetails.getNomResponsable(),
				userDetails.getMatriculeP(), userDetails.getEmail(), userDetails.getPassword(), userDetails.getNom(),
				userDetails.getPrenom(), userDetails.getNumTel(), userDetails.getPoste(), userDetails.getDepartement(),
				roles));
	}
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
		...
		Personnel user = new Personnel(signUpRequest.getEmail(), signUpRequest.genererMatricule(),
				signUpRequest.getNom(), signUpRequest.getPrenom(), signUpRequest.getDepartement(),
				signUpRequest.getNomResponsable(), signUpRequest.getNumTel(), signUpRequest.getPoste(),
